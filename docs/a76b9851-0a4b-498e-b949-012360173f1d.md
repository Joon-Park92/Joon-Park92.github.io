...
type: resource
created: 2024-08-21
legacy_task_id: TSK-1970
publish: true
tags:
    - taxonomy/decision-science/decision-theory
index: "[[@decision-science]]"
---
...
<details class="note" markdown="1">
<summary>생성 모델 (Generative model) 예시</summary>
...
<details class="note" markdown="1">
<summary>판별 모델 (Discriminative model) 예시</summary>
...
<details class="note" markdown="1">
<summary>판별 함수 (Discriminant function) 예시</summary>
